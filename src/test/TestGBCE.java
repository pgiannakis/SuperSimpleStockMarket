...
public class TestGBCE {
	...
	public void setUp() throws Exception {
		...
		add(new StockAndTrade(new Stock("JOE", StockType.COMMON, 13.0, 0.0, 250.0),
				new ArrayList<Trade>(){{
					add(new Trade(new Date(),20,Indicator.SELL,7));
	...
	public void testCalculateFinancialRatio() {
		FinancialRatio gbce = new GBCE(stockAndTradeArray,2);
		assertEquals(5.79902749,gbce.calculateFinancialRatio(),0.001);
	}
